  ...
  return (
    <div className="">
      ...
      <div className="min-h-screen w-full flex justify-center items-center flex-col bg-black ">
        ...
        <div className="w-[250px] md:w-[90%] h-[90vh] mt-2  p-2 border-x-4 border-white">
          <ThreeScene></ThreeScene>
        </div>

        <div className="w-[250px] md:w-[90%] h-[90vh]   p-2 border-x-4 border-white">
          <ModelView></ModelView>
        </div>
        {/* 
        <div className="w-[250px] md:w-[90%] h-[90vh]   p-2 border-x-4 border-y-4 border-black ">
          <ModelView></ModelView>
        </div> */}
      </div>
